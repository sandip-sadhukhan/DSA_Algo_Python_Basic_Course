...
class Graph(object):
    ...
    def get_edge_list(self):
        ...
        return [
            (e.value, e.node_from.value, e.node_to.value) for e in self.edges
        ]
...
# Should print:
# Depth First Search
# ['London', 'Shanghai', 'Mountain View',
# 'San Francisco', 'Berlin', 'Sao Paolo']

print("\nBreadth First Search")
pp.pprint(graph.bfs_names(2))
# test error reporting
# pp.pprint(['Sao Paolo', 'Mountain View',
#  'San Francisco', 'London', 'Shanghai', 'Berlin'])

# Should print:
# Breadth First Search
# ['London', 'Shanghai', 'Berlin',
# 'Sao Paolo', 'Mountain View', 'San Francisco']
